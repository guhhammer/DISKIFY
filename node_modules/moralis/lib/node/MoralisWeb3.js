...
class MoralisWeb3 {
  ...
  static async handleTriggers(_triggersArray) {
    ...
    for (let i = 0; i < _triggersArray.length; i++) {
      ...
      switch ((_triggersArray$i = _triggersArray[i]) === null || _triggersArray$i === void 0 ? void 0 : _triggersArray$i.name) {
        ...
        case 'openUrl':
          ...
          if (((_triggersArray$i7 = _triggersArray[i]) === null || _triggersArray$i7 === void 0 ? void 0 : _triggersArray$i7.shouldReturnResponse) === true) return response;
          break;
        // Handles `web3Transaction` trigger

        case 'web3Transaction':
          if (!this.ensureWeb3IsInstalled()) throw new Error(ERROR_WEB3_MISSING);
          if (((_triggersArray$i8 = _triggersArray[i]) === null || _triggersArray$i8 === void 0 ? void 0 : _triggersArray$i8.shouldAwait) === true) response = await this.web3.eth.sendTransaction((_triggersArray$i9 = _triggersArray[i]) === null || _triggersArray$i9 === void 0 ? void 0 : _triggersArray$i9.data);
          ...
          if (((_triggersArray$i12 = _triggersArray[i]) === null || _triggersArray$i12 === void 0 ? void 0 : _triggersArray$i12.shouldReturnResponse) === true) return response;
          break;

        default:
          throw new Error(`Unknown trigger: "${(_triggersArray$i13 = _triggersArray[i]) === null || _triggersArray$i13 === void 0 ? void 0 : _triggersArray$i13.name}"`);
      }
    }
  }
